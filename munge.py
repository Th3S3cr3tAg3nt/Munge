...
def munge(wrd, level):
    ...
    if level > 0:
        wordlist.add(wrd)
        wordlist.add(wrd.upper())
        wordlist.add(wrd.capitalize())

    if level > 2:
        temp = wrd.capitalize()
        wordlist.add(temp.swapcase())

    # Leet speak
    if level > 4:
        wordlist.add(wrd.replace('e', '3'))
        wordlist.add(wrd.replace('a', '4'))
        wordlist.add(wrd.replace('o', '0'))
        wordlist.add(wrd.replace('i', '!'))
        wordlist.add(wrd.replace('i', '1'))
        wordlist.add(wrd.replace('l', '1'))
        wordlist.add(wrd.replace('a', '@'))
        wordlist.add(wrd.replace('s', '$'))
